...
import {
  PROJECT_COLOR_SCHEME_BY_CATEGORY,
  getPortfolioProjectColorScheme,
  restorePortfolioProjectColorSchemes,
} from "./projectColorSchemes";
...
export default function App() {
    ...
    if (cached) {
      try {
        ...
        if (Array.isArray(parsedProjects)) {
          return restorePortfolioProjectColorSchemes(parsedProjects);
        }
      } catch (e) { }
    }
  ...
  const PRESET_QUESTIONS = [
    { text: "ספר לי על הניסיון של איתן בדיסקונט", short: "הניסיון בדיסקונט", icon: ShieldCheck },
    { text: "באילו טכנולוגיות וכלים איתן שולט?", short: "ארסנל טכנולוגי", icon: Cpu },
    { text: "מדוע איתן מתאים במיוחד להשתלבות מהירה?", short: "יתרון השתלבות", icon: UserCheck },
    { text: "ספר לי על הפרויקטים העצמאיים וה-AI של איתן", short: "חדשנות ו-AI", icon: Sparkles }
  ];
    ...
    if (editingProject) {
      ...
      setProjects(prev => prev.map(p => {
        if (p.id === editingProject.id) {
          const colorScheme = formCategory === p.category
            ? getPortfolioProjectColorScheme(p)
            : PROJECT_COLOR_SCHEME_BY_CATEGORY[formCategory];
      ...
      const newProj: Project = {
        ...
        features: featuresArray,
        colorScheme: PROJECT_COLOR_SCHEME_BY_CATEGORY[formCategory]
      };
          ...
          <div className="flex justify-between items-center h-24">
            ...
            <div className="flex items-center md:hidden">
              <button
                ...
                className="p-2.5 text-[#1A1A1A] hover:bg-black/5 transition-colors"
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center p-8 sm:p-12 relative">
                ...
                <div className="lg:col-span-8 space-y-6">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#E7E1D3] text-xs font-sans font-bold text-[#1A1A1A] border border-black/10">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#e07631]" />
                    זמין להשתלבות מהירה בבנק דיסקונט / משרות פיתוח בכירות
                  </div>

                  <h2 className="font-sans font-black mb-4 leading-[1.1] text-[#1A1A1A]">
                    <span className="block text-4xl sm:text-5xl lg:text-6xl">מפתח תוכנה וקוד</span>
                    <span className="block text-xl sm:text-2xl lg:text-3xl font-extrabold text-[#a89150] mt-3">עם 18 שנות ניסיון</span>
                  </h2>

                  <p className="text-base sm:text-lg text-[#1A1A1A] leading-relaxed max-w-3xl font-sans">
                    שלום, אני <strong className="text-[#1A1A1A] font-extrabold">איתן ברון</strong>. 11 שנים מהקריירה שלי הוקדשו לפיתוח, כתיבה ואופטימיזציה של מערכות הליבה בבנק דיסקונט. כמי שמכיר היטב את תשתיות הבנק, מסדי הנתונים, אבטחת המידע והתרבות הארגונית שלו – אני יציב, יעיל ומביא איתי ערך קריטי של <span className="text-black font-extrabold">תרומה מיידית ללא תקופת חפיפה מורכבת</span>.
                  </p>
                  ...
                  <div className="flex flex-wrap gap-4 pt-4">
                    <button
                      onClick={() => setActiveTab("chat")}
                      className="px-8 py-3.5 bg-[#e07631] hover:bg-[#1A1A1A] text-white text-xs font-sans font-extrabold cursor-pointer transition-colors duration-150 flex items-center gap-2"
                    >
                    ...
                    <button
                      onClick={() => setActiveTab("portfolio")}
                      className="px-8 py-3.5 bg-[#1A1A1A] hover:bg-[#e07631] text-[#FAF9F6] text-xs font-sans font-extrabold cursor-pointer transition-colors duration-150 flex items-center gap-1.5"
                    >
                    ...
                    <button
                      onClick={() => setActiveTab("resume")}
                      className="px-8 py-3.5 bg-[#E7E1D3] border border-[#1A1A1A]/25 hover:bg-[#1A1A1A] hover:text-[#FAF9F6] hover:border-[#1A1A1A] text-[#1A1A1A] text-xs font-sans font-extrabold cursor-pointer transition-colors duration-150 flex items-center gap-1.5"
                    >
                ...
                <div className="lg:col-span-4 flex flex-col justify-center items-center">
                  <div className="relative p-2 bg-[#FAF9F6] border border-black/10 shadow-2xl">
                    <div className="w-48 h-56 bg-[#E7E1D3] overflow-hidden relative">
                      <img
                        src="/picture.png"
              ...
              <div className="bg-gradient-to-br from-[#FBFAF7] to-[#F1EBDD] p-8 border border-black/10 text-[#1A1A1A] flex flex-col md:flex-row justify-between items-center gap-6 relative overflow-hidden">
                {/* Warm brand accent strip */}
                <div className="pointer-events-none absolute top-0 right-0 h-full w-1.5 bg-[#e07631]" />

                <div className="space-y-2 text-right">
                  <h3 className="text-xl sm:text-2xl font-sans font-extrabold flex items-center gap-2 text-[#1A1A1A]">
                ...
                <button
                  onClick={() => setActiveTab("resume")}
                  className="px-6 py-3.5 bg-[#e07631] hover:bg-[#1A1A1A] hover:text-white text-white text-xs font-sans font-extrabold cursor-pointer transition-colors duration-150 flex items-center gap-1.5 whitespace-nowrap"
                >
                  הצג את קורות החיים
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-[#FAF9F6] p-6 border border-black/10 space-y-4 relative">
                    <div className="w-12 h-12 bg-[#E7E1D3] border border-black/5 flex items-center justify-center text-[#e07631]">
                  ...
                  {/* Advantage 2 */}
                  <div className="bg-[#FAF9F6] p-6 border border-black/10 space-y-4 relative">
                    <div className="w-12 h-12 bg-[#E7E1D3] border border-black/5 flex items-center justify-center text-[#1A1A1A]">
                ...
                <div className="bg-[#FAF9F6] p-8 border border-black/10 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {PROFILE_STATS.map((stat, idx) => (
                      <div key={idx} className="bg-[#E7E1D3] p-4 text-center space-y-1 border border-black/5">
                  ...
                  <div className="bg-[#E7E1D3] p-4 text-xs text-[#1A1A1A] leading-relaxed border-l-4 border-[#e07631] font-sans flex items-start gap-2">
                    <GraduationCap className="w-4 h-4 text-[#e07631] flex-shrink-0 mt-0.5" />
                    <span><strong>הערה אקדמית:</strong> איתן סיים את התואר כמהנדס תוכנה (B.Tech) במכללת סמי שמעון עם ציוני 90+ בכל השפות, ופרויקט גמר מצטיין בציון 94. ההנדסאי שלו הסתיים עם פרויקט גמר ב-VB6 בציון 100!</span>
                  </div>
                </div>
                  ...
                  <div className="space-y-4" dir="ltr">
                    {CORE_SKILLS.map((skill, idx) => (
                      <div key={idx} className="space-y-1">
                        ...
                        <div className="w-full h-1.5 bg-[#E7E1D3] overflow-hidden">
                          <div
            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-black/10 pb-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {/* Category filters */}
                  <div className="flex flex-wrap gap-1 bg-[#E7E1D3] p-1 border border-black/10">
                    {[
                      { id: "all", label: "הכל" },
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-sans font-bold uppercase transition-colors cursor-pointer ${projectFilter === btn.id ? "bg-black text-white" : "text-[#1A1A1A] hover:bg-[#e07631] hover:text-white"}`}
                      >
                        {btn.label}
                      </button>
                    ))}
                  ...
                  {isAdmin && (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 bg-[#E7E1D3] border border-black/10 hover:bg-black hover:text-white text-[#1A1A1A] text-xs font-bold flex items-center gap-1 cursor-pointer"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProjects.map((project) => (
                  ...
                  >
                    ...
                    <div className="p-5 flex-grow space-y-4 flex flex-col justify-between">
                      ...
                      <div className="flex flex-wrap gap-1 pt-2">
                        {project.tags.slice(0, 3).map((tag, tIdx) => (
                          <span key={tIdx} className="px-2 py-0.5 bg-[#E7E1D3] border border-black/5 text-[#1A1A1A] text-xs font-sans font-bold ltr">
                            {tag}
                          </span>
                        ))}
                    ...
                    {/* Bottom arrow CTA */}
                    <div className="px-5 py-3 border-t border-black/10 bg-[#E7E1D3]/30 flex justify-between items-center text-xs font-sans font-extrabold text-[#1A1A1A] hover:bg-[#E7E1D3]/60 transition-colors">
              ...
              {filteredProjects.length === 0 && (
                <div className="text-center py-16 bg-[#FAF9F6] border border-black/10 rounded-none space-y-2">
                  <Briefcase className="w-12 h-12 text-[#1A1A1A]/20 mx-auto" />
                  <p className="text-sm font-bold text-[#1A1A1A]/55">אין פרויקטים תחת קטגוריה זו כרגע.</p>
                </div>
              )}
                    ...
                    >
                      ...
                      <div className="p-8 space-y-6 text-right">
                        ...
                        {selectedProject.features && selectedProject.features.length > 0 && (
                          <div className="space-y-3 bg-[#E7E1D3] p-5 border border-black/5">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {selectedProject.tags.map((tag, tIdx) => (
                              <span key={tIdx} className="px-2.5 py-1 bg-[#E7E1D3] text-black border border-black/10 font-mono text-xs ltr">
                                {tag}
                              </span>
                            ))}
                          </div>
          ...
          {activeTab === "chat" && (
            ...
            >
              ...
              <div className="bg-black text-white p-5 flex justify-between items-center gap-4 border-b border-black/10">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <div className="w-11 h-11 bg-[#E7E1D3] text-black border border-black/10 rounded-none flex items-center justify-center font-sans font-extrabold text-sm">
                      AI
                    </div>
              ...
              <div className="bg-[#E7E1D3] border-b border-black/10 px-4 py-3">
                  ...
                  {PRESET_QUESTIONS.map((question, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className="group px-3 py-1.5 bg-white hover:bg-black hover:text-white disabled:opacity-50 text-[#1A1A1A] rounded-none text-xs font-sans font-bold border border-black/10 cursor-pointer transition-colors text-right flex items-center gap-1.5"
                      >
                        <QIcon className="w-3.5 h-3.5 text-[#e07631] group-hover:text-white transition-colors" />
                        {question.short}
                      </button>
                    );
                  })}
              ...
              <div className="flex-grow p-4 sm:p-6 overflow-y-auto bg-[#FAF9F6]/50 space-y-4">
                ...
                {chatMessages.map(msg => (
                  ...
                  >
                    <div className={`max-w-[85%] p-4 text-sm leading-relaxed border border-black/10 rounded-none space-y-1 ${msg.sender === "user" ? "bg-[#e07631] text-white" : "bg-[#E7E1D3] text-[#1A1A1A]"}`}>
                ...
                {isChatLoading && (
                  <div className="flex justify-start">
                    <div className="bg-[#E7E1D3] border border-black/10 rounded-none p-4 shadow-none">
                      <div className="flex items-center gap-2">
              ...
              >
                ...
                <button
                  ...
                  className="px-5 bg-black hover:bg-[#e07631] disabled:bg-[#E7E1D3] disabled:text-[#1A1A1A]/40 text-white rounded-none cursor-pointer transition-colors duration-150 flex items-center justify-center font-mono text-[10px] uppercase font-bold tracking-widest"
      ...
      <footer className="bg-[#FAF9F6] border-t border-black/10 py-8 lg:py-12 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-xs font-bold text-[#1A1A1A]/60">
              <span className="text-[#1A1A1A] border-l border-black/15 pl-4">צור קשר עם איתן:</span>
              <a href="tel:054-3033425" className="flex items-center gap-1.5 hover:text-[#e07631] transition-colors">
                <Phone className="w-4 h-4 text-[#e07631]" />
                054-3033425
              </a>
              <a href="mailto:eitan2007@gmail.com" className="flex items-center gap-1.5 hover:text-[#e07631] transition-colors">
                <Mail className="w-4 h-4 text-[#e07631]" />
                eitan2007@gmail.com
              </a>
              <a href="https://www.eitan.work" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 hover:text-[#e07631] transition-colors">
                <Globe className="w-4 h-4 text-[#e07631]" />
                www.eitan.work
              </a>
            </div>

            {/* Admin trigger & copyright */}
            <div className="flex items-center gap-4 text-xs font-semibold text-[#1A1A1A]/55">
              <span>© {new Date().getFullYear()} איתן ברון • כל הזכויות שמורות</span>
              <span className="text-black/15">|</span>
              {isAdmin ? (
                <button onClick={handleAdminLogout} className="text-[#e07631] hover:text-[#1A1A1A] flex items-center gap-1 cursor-pointer transition-colors">
                  התנתק ממצב עריכה
                </button>
              ) : (
                <button onClick={() => setShowLoginModal(true)} className="text-[#1A1A1A]/45 hover:text-[#e07631] flex items-center gap-1 cursor-pointer transition-colors">
          ...
          <div className="text-center text-[10px] text-[#1A1A1A]/40 font-medium">
        ...
        {showLoginModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-[#FAF9F6] max-w-sm w-full p-6 z-10 border border-black space-y-4"
            >
              <div className="flex justify-between items-center border-b border-black/10 pb-3">
                <h3 className="font-sans font-bold text-base flex items-center gap-1.5 text-[#1A1A1A]">
                  <Lock className="w-4 h-4 text-[#e07631]" />
                  כניסת מנהל למערכת העריכה
                </h3>
                <button onClick={() => setShowLoginModal(false)} className="text-[#1A1A1A]/50 hover:bg-black/5 hover:text-[#1A1A1A] p-1 rounded-none cursor-pointer transition-colors">
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <form onSubmit={handleAdminLogin} className="space-y-4 text-right">
                ...
                <div className="flex justify-end gap-2 pt-2">
                  <button
                    type="button"
                    onClick={() => setShowLoginModal(false)}
                    className="px-4 py-2 bg-[#E7E1D3] text-black rounded-none text-[10px] font-mono uppercase tracking-widest font-bold cursor-pointer"
                  >
                    ביטול
                  </button>
                  <button
        ...
        {showManageModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-[#FAF9F6] max-w-lg w-full max-h-[85vh] overflow-y-auto p-6 z-10 border border-black space-y-4"
            >
              <div className="flex justify-between items-center border-b border-black/10 pb-3">
                <h3 className="font-sans font-bold text-base flex items-center gap-1.5 text-[#1A1A1A]">
                ...
                <button onClick={() => setShowAddEditModal(false)} className="text-[#1A1A1A]/50 hover:bg-black/5 hover:text-[#1A1A1A] p-1.5 rounded-none cursor-pointer transition-colors">
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <form onSubmit={handleSaveProject} className="space-y-4 text-right">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 text-xs bg-[#E7E1D3] border border-black/15 rounded-none outline-none focus:border-black font-mono"
                    >
                ...
                <div className="space-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[9px] font-mono text-[#1A1A1A]/45">למשל: Java, Next.js, Oracle</span>
                  </div>
                  <input
                    type="text"
                    value={formTags}
                ...
                <div className="space-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[9px] font-mono text-[#1A1A1A]/45">כל שורה תהפוך לבולט מוכן</span>
                  </div>
                  <textarea
                    value={formFeatures}
